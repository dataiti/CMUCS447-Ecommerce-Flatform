...
const Pagination = ({ totalPage, handlePageChange, page, limit, setLimit }) => {
  return (
    <div className="py-3 px-6 flex items-center justify-between">
      ...
      <div>
        ...
        <input
          type="number"
          placeholder="số dòng"
          className="outline-none pl-2 py-1 bg-gray-200 w-20 rounded-sm border-1 border-gray-300 text-sm"
          value={limit}
